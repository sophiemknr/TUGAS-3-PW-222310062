                        ...
                        <div class="card border h-100">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a href="<?php echo e(url('sign-in/pa')); ?>" class="btn btn-lg btn-primary">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card border h-100">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a href="<?php echo e(url('sign-in/pb')); ?>" class="btn btn-lg btn-primary">
                                        Click disini untuk melihat hasil kerja yang telah dibuat
                                    </a>
                                </div>
                            </div>
...
<?php /**PATH D:\Semester 4\222310062_ProjectPW\tugas-4\resources\views/pertemuan-6/P6Task.blade.php ENDPATH**/ ?>